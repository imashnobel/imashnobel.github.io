...
const highlights = [
  { icon: <FiCloud className="text-orange-400 text-xl" />, text: "Manage and optimize AWS cloud infrastructure — EC2, RDS, S3, IAM, EKS — for cost-effective, highly available production systems" },
  { icon: <FiServer className="text-amber-400 text-xl" />, text: "Run FastPay, ZiCharge, HappyHaat & Fast Connect production services for a fintech company in production, today" },
  ...
  return (
    <section id="about" className="py-28 px-6">
      <div className="max-w-6xl mx-auto" ref={ref}>
        ...
        >
          <span className="text-orange-400 text-sm font-semibold tracking-widest uppercase">About Me</span>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-orange-500/20 to-amber-500/20 rounded-2xl blur-sm" />
              <div className="relative bg-[#0f172a] border border-white/5 rounded-2xl p-8">
                <p className="text-slate-300 text-base leading-relaxed mb-5">
                  ...
                  <span className="text-orange-400 font-semibold">DevOps Engineer</span> at{" "}
                ...
                <p className="text-slate-300 text-base leading-relaxed mb-5">
                  ...
                  <span className="text-orange-400 font-medium">Amazon EC2</span>,{" "}
                  <span className="text-orange-400 font-medium">Docker</span> and{" "}
                  <span className="text-orange-400 font-medium">AWS EKS</span>, codifying it all with{" "}
                ...
                <p className="text-slate-300 text-base leading-relaxed">
                  This work supports{" "}
                  <span className="text-amber-400">FastPay</span>,{" "}
                  <span className="text-amber-400">ZiCharge</span>,{" "}
                  <span className="text-amber-400">HappyHaat</span> and{" "}
                  <span className="text-amber-400">Fast Connect</span> — in production, at the same time,
          ...
          >
            {highlights.map((h, i) => (
              <motion.div
                ...
                className="flex items-start gap-4 bg-[#0f172a] border border-white/5 rounded-xl p-5 hover:border-orange-500/20 transition-colors"
              >
