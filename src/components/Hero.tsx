  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-5 md:px-6 text-center w-full">
        ...
        >
          DevOps Engineer with 8+ years in IT and 3+ years focused on cloud and DevOps engineering. I build reliable, automated infrastructure on AWS — from CI/CD pipelines to containerized deployments — paired with Prometheus, Grafana and CloudWatch so issues surface as alerts, not outages.
        </motion.p>
        ...
        >
          {[
            { icon: <FiGithub />, href: "https://github.com/imashnobel", label: "GitHub" },
            { icon: <FiLinkedin />, href: "https://www.linkedin.com/in/imashrafuzzaman/", label: "LinkedIn" },
            { icon: <FiMail />, href: "mailto:ashrafuzzamannobel@gmail.com", label: "Email" },
          ].map((s) => (
            <a
              key={s.label}
              href={s.href}
